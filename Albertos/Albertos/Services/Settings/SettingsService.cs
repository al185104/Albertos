...
namespace Albertos.Services.Settings
{
    public class SettingsService : ISettingsService
    {
        ...
        // skan-keys
        private const string IdItemAnimation = "item_animation";
        ...
        // skan-values
        private readonly bool ItemAnimationDefault = true;
        ...
        //skan
        public bool ItemAnimation
        {
            get => GetValueOrDefault(IdItemAnimation, ItemAnimationDefault);
            set => AddOrUpdateValue(IdItemAnimation, value);
        }
