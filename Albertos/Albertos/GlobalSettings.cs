...
namespace Albertos
{
    public class GlobalSetting
    {
        ...
        //public const string DefaultEndpoint = "http://skan.azurewebsites.net"; // i.e.: "http://YOUR_IP" or "http://YOUR_DNS_NAME"
        public const string DefaultEndpoint = "http://skanapi.azurewebsites.net";
